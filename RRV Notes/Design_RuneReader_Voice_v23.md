...
Last Updated: April 2026 | Version 23
...
RuneReaderVoice v23 expands the Phase 5 server backend roster, hardens the worker subprocess architecture with centralized GPU resource management, fixes a root-cause CosyVoice truncation bug, and adds synthesis metrics headers to both API endpoints for structured benchmarking.
